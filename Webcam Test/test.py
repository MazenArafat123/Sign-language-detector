...
model = load_model(
    r"D:\Courses\DEPI\1- Technical\Project\Sign-language-detector\Models\asl_landmarks_final.h5")
with open(r"D:\Courses\DEPI\1- Technical\Project\Sign-language-detector\Models\asl_landmarks_classes.pkl", 'rb') as f:
